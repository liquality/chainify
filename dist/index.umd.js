	...
	var Client = function () {
	  ...
	  _createClass(Client, [{
	    ...
	    value: function _checkMethod(method) {
	      ...
	      if (!lodash.isFunction(this.provider[method])) {
	        throw new Error('Unimplemented method: ' + method);
	      }

	      if (lodash.isFunction(this.provider._checkMethodVersionSupport)) {
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                if (lodash.isNumber(numberOfBlocks)) {
	                  _context.next = 3;
	                  break;
	                }
	              ...
	              case 8:
	                invalidBlock = lodash.find(blockHashes, function (blockHash) {
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                if (lodash.isNumber(blockNumber)) {
	                  _context2.next = 3;
	                  break;
	                }
	          ...
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              ...
	              case 3:
	                ...
	                if (lodash.isNumber(blockHeight)) {
	                  _context3.next = 6;
	                  break;
	                }
