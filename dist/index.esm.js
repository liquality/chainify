...
function praseResponse(body, headers) {
  ...
  if (body.error) {
    throw new Error("Error occurred while processing the RPC call: ".concat(body.error));
  }

  if (!has_1(body, 'result')) {
...
function () {
  ...
  _createClass(BitcoinRPCProvider, [{
    ...
    key: "generateBlock",
    value: function () {
      var _generateBlock = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(numberOfBlocks) {
      ...
      return function generateBlock(_x) {
        return _generateBlock.apply(this, arguments);
      };
    }()
  }]);
...
var BitcoinLedgerProvider =
/*#__PURE__*/
function (_BitcoinRPCProvider) {
  _inherits(BitcoinLedgerProvider, _BitcoinRPCProvider);

  function BitcoinLedgerProvider(uri, user, pass) {
    var _this;

    _classCallCheck(this, BitcoinLedgerProvider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(BitcoinLedgerProvider).call(this, uri, user, pass));
    _this._ledgerBtc = false;
    _this._derivationPath = "44'/0'/0'/0";
    return _this;
  }

  _createClass(BitcoinLedgerProvider, [{
    key: "_connectToLedger",
    value: function () {
      var _connectToLedger2 = _asyncToGenerator(
      /*#__PURE__*/
      ...
      return function _connectToLedger() {
        return _connectToLedger2.apply(this, arguments);
      };
    }()
  }, {
    key: "_updateDerivationPath",
    value: function () {
      var _updateDerivationPath2 = _asyncToGenerator(
      /*#__PURE__*/
      ...
      return function _updateDerivationPath(_x) {
        return _updateDerivationPath2.apply(this, arguments);
      };
    }()
  }, {
    key: "getAddresses",
    value: function () {
      var _getAddresses = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3() {
        var _ref, bitcoinAddress;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                _ref = _context3.sent;
                bitcoinAddress = _ref.bitcoinAddress;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee4(message, from) {
        var hex;
...
var EthereumRPCProvider =
/*#__PURE__*/
function () {
  function EthereumRPCProvider(uri) {
    _classCallCheck(this, EthereumRPCProvider);
  ...
  _createClass(EthereumRPCProvider, [{
    key: "_rpc",
    value: function _rpc(method) {
      for (var _len = arguments.length, params = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        params[_key - 1] = arguments[_key];
...
var EthereumLedgerProvider =
/*#__PURE__*/
function (_EthereumRPCProvider) {
  _inherits(EthereumLedgerProvider, _EthereumRPCProvider);

  function EthereumLedgerProvider(uri, user, pass) {
    var _this;

    _classCallCheck(this, EthereumLedgerProvider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EthereumLedgerProvider).call(this, uri, user, pass));
    _this._ledgerEth = false;
    _this._derivationPath = "44'/60'/0'/0'/0";
    return _this;
  }

  _createClass(EthereumLedgerProvider, [{
    key: "_connectToLedger",
    value: function () {
      var _connectToLedger2 = _asyncToGenerator(
      /*#__PURE__*/
    ...
    value: function () {
      ...
      return function signMessage(_x2) {
        return _signMessage.apply(this, arguments);
      };
    }()
  }]);
...
var EthereumMetaMaskProvider =
/*#__PURE__*/
function () {
  function EthereumMetaMaskProvider(metamaskProvider) {
    _classCallCheck(this, EthereumMetaMaskProvider);

    if (!isFunction_1(metamaskProvider.sendAsync)) {
  ...
  _createClass(EthereumMetaMaskProvider, [{
    key: "_toMM",
    value: function _toMM(method) {
      ...
      return new Promise(function (resolve, reject) {
        _this._metamaskProvider.sendAsync({
          method: method,
          params: params
        }, function (err, data) {
          if (err) {
    ...
    value: function () {
      var _signMessage = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(message, from) {
        var hex;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                hex = Buffer.from(message).toString('hex');
                return _context2.abrupt("return", this._toMM('personal_sign', "0x".concat(hex), from));
...
function () {
  ...
  _createClass(Client, [{
    ...
    value: function _checkMethod(method) {
      ...
      if (!isFunction_1(this.provider[method])) {
        throw new Error("Unimplemented method: ".concat(method));
      }

      if (isFunction_1(this.provider._checkMethodVersionSupport)) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                invalidBlock = find_1(blockHashes, function (blockHash) {
    ...
    value: function () {
      var _getBlockByNumber = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(blockNumber) {
        var includeTx,
            block,
            _args2 = arguments;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                includeTx = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : false;

                this._checkMethod('getBlockByNumber');

                if (isNumber_1(blockNumber)) {
                  _context2.next = 4;
                  break;
                }
      ...
      return function getBlockByNumber(_x2) {
    ...
    key: "getBlockHeight",
    value: function () {
      var _getBlockHeight = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3() {
        var blockHeight;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
      ...
      return function getBlockHeight() {
    ...
    value: function () {
      var _signMessage = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(message, from) {
        var signedMessage;
