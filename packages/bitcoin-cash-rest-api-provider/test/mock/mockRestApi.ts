...
function mockRestApi() {
  ...
  nock('https://testnet3.fullstack.cash:443', { encodedQueryParams: true })
    .post(
      '/v4/rawtransactions/getRawTransaction',
      '{"txids":["21d823eb78929c6edca4e12c3f2411f7e31220bcaad19d99740bd313f393a0bd"],"verbose":true,"usrObj":null}'
    )
    .reply(
      200,
      [
