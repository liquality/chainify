...
import { HTLCDataStruct } from "../src/types/LiqualityHTLC";
import { Signers } from "./types";

export function generateId(htlcData: HTLCDataStruct, blockTimestamp: number) {
...
export async function getDefaultHtlcData(
  signers: Signers,
  expiration: number,
