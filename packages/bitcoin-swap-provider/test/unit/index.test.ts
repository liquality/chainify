...
describe('Bitcoin Swap provider', () => {
  ...
  describe('Generate swap', () => {
    it('should generate correct bytecode', () => {
      return expect(provider.getSwapOutput({
    ...
    it('should generate correct bytecode with big expiration', () => {
      return expect(provider.getSwapOutput({
        ...
        .to.equal('6382012088a820ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff8876a91477195a4f131ed1de8a5b10ce236f169b2f58cba8670568ef33d700b17576a91477195a4f131ed1de8a5b10ce236f169b2f58cba86888ac')
    })
  })
