...
function mockBatchEsploraApi() {
  nock('https://blockstream.info:443', { encodedQueryParams: true })
    ...
    .reply(
      200,
      [{ "address": "2N4N393YJx9KuZV5D4HMkzHZ7QoFp6tJG1b", "utxo": [{ "txid": "374d22560325e43a314f15120ba8d3ab1840e87695119d3208308dd2868cf9a3", "vout": 0, "status": { "confirmed": true, "block_height": 1973185, "block_hash": "0000000000edbe057f877fdb0de069f636f6a9b03451aa748e8fa77546fcbbf8", "block_time": 1619775030 }, "value": 10384287 }] }],
      [
        'Server',
        'nginx',
        'Date',
