export default {
        ...
        vout: [
          {
            ...
            scriptPubKey: {
              ...
              reqSigs: 1,
              type: 'pubkey',
              addresses: ['bchtest:qrxjjxg7d5z4jjm7nx782euecjlsqr4nqywt0qursc']
            }
          },
          {
            value: 0.0,
  ...
  signmessage: [
    {
      params: ['bchtest:qqqgxd953k7guk4wurwnnsmww8mud9tuyqqcgmnumd', 'liquality'],
  ...
  gettransaction: [
    {
      ...
      result: {
        ...
        details: [
          {
            address: 'bchtest:pqlt35hmu8mxzj646he3amxqw3n8ed5scqj34qn9gw',
            category: 'send',
            amount: -0.0001,
            label: '',
            vout: 1,
  ...
  getreceivedbyaddress: [
    {
      params: ['bchtest:qrt3pnkwywj2j22n8aftjphs77vtrtrmeqwkmtcqr2'],
      result: 0
    },
    {
      params: ['bchtest:qps9fqnlc4l4v4h4gq03wtz46nucrdjra5nm9cy5kk'],
      result: 0.6
    },
    {
      params: ['bchtest:qrcv7fptattcsuy9mhn542myutdv5emn35dxvn7x62'],
      result: 0
    }
  ],
  listunspent: [
    {
      params: [0, 9999999, ['bchtest:qps9fqnlc4l4v4h4gq03wtz46nucrdjra5nm9cy5kk']],
      result: [
        {
          txid: '467dec8ca158d0939e27e49e86dddf996020e707e1c68a68e6990a6770833474',
          vout: 0,
          address: 'bchtest:qps9fqnlc4l4v4h4gq03wtz46nucrdjra5nm9cy5kk',
  ...
  getnewaddress: [
    {
      params: ['', 'legacy'],
      result: 'bchtest:qrcv7fptattcsuy9mhn542myutdv5emn35dxvn7x62'
    }
  ],
  getblockcount: [
    {
