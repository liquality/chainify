...
import { EthereumRpcFeeProvider } from '../../packages/ethereum-rpc-fee-provider'
...
ethereumWithMetaMask.addProvider(new EthereumRpcFeeProvider())
...
ethereumWithNode.addProvider(new EthereumRpcFeeProvider())
...
ethereumWithLedger.addProvider(new EthereumRpcFeeProvider())
...
ethereumWithJs.addProvider(new EthereumRpcFeeProvider())
...
erc20WithMetaMask.addProvider(new EthereumRpcFeeProvider())
...
erc20WithNode.addProvider(new EthereumRpcFeeProvider())
...
erc20WithLedger.addProvider(new EthereumRpcFeeProvider())
...
erc20WithJs.addProvider(new EthereumRpcFeeProvider())
