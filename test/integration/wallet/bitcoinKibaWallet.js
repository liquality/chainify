...
import { chains, fundUnusedBitcoinAddress, importBitcoinAddresses, mineBitcoinBlocks, connectKiba } from '../common'
...
describe('Wallet Interaction', function () {
  ...
  describe('Bitcoin - Kiba', () => {
    ...
    //   await importBitcoinAddresses(chains.bitcoinWithKiba)
    // })
