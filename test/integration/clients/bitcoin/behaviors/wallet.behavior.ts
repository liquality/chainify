...
import { BitcoinBaseWalletProvider } from '@liquality/bitcoin';
...
export function shouldBehaveLikeBitcoinWallet(chain: Chain) {
        ...
        describe('getWalletAddress', () => {
            it('should return address if derivation is within 1000 address index places', async () => {
                ...
                const { derivationPath: expectedDerivationPath, publicKey: expectedPublicKey } = await (
                    chain.client.wallet as BitcoinBaseWalletProvider
