...
chains.bitcoin.addProvider(new providers.bitcoin.BitcoinBitcoreRpcProvider('http://localhost:18334', 'bitcoin', 'local321'))
...
chains.bitcoin.addProvider(new providers.bitcoin.BitcoinNodeWalletProvider(networks.bitcoin_testnet, 'http://localhost:18334', 'bitcoin', 'local321'))
chains.bitcoin.addProvider(new providers.bitcoin.BitcoinSwapProvider({ network: networks.bitcoin_testnet }))
